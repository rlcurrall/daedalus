...
type BaseBadgeButtonProps = BadgeProps & { children: React.ReactNode };
type BadgeButtonProps = BaseBadgeButtonProps & HeadlessButtonProps;
type BadgeLinkProps = BaseBadgeButtonProps &
...
export const BadgeButton = React.forwardRef(function BadgeButton(
  {
    ...
    children,
    ...props
  }: BadgeButtonProps | BadgeLinkProps,
